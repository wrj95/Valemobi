...
public class Valemobi {
    ...
    public static void main(String[] args) {
        ...
        float media = 0;
        for (Pessoa p : people) {
            //Conta da média da quantidade obtida de cada Pessoa
            media = (float) (media + p.getVl_total());

            //Apresenta o ID, nome e quanto cada usuário tem
    ...
    //Metodo alheio para inserções de teste no bd
    public static void inserções(EntityManagerFactory emf) {
